...
sampleepisode = {
    "audio_preview_url": "https://p.scdn.co/mp3-preview/060812a16680d06fbb4def02c4ada0e02f9af98c",
    "description": "<description snipped>",
    "duration_ms": 1432943,
    "explicit": False,
    "external_urls": {
        "spotify": "https://open.spotify.com/episode/0BqdbC2mOYXI6ywXpVpiMc"
    },
    "href": "https://api.spotify.com/v1/episodes/0BqdbC2mOYXI6ywXpVpiMc",
    "html_description": "<description snipped>",
    "id": "0BqdbC2mOYXI6ywXpVpiMc",
    "images": [
        {
            "height": 640,
    ...
    "language": "en",
    "languages": ["en"],
    "name": "Why Spending Too Little Could Backfire on Democrats",
    "release_date": "2021-10-26",
    "release_date_precision": "day",
    "resume_point": {"fully_played": False, "resume_position_ms": 0},
    "type": "episode",
    "uri": "spotify:episode:0BqdbC2mOYXI6ywXpVpiMc",
}


class Test_is_played_Method(unittest.TestCase):
    @staticmethod
    def test_is_played_not_played():
...
class TestInitMethod(unittest.TestCase):
    def test_no_plname_given(
        self,
    ):
        with self.assertRaises(AttributeError):
            build = PlaylistGenerator()  # noqa: F841
